        ...
        this.$('.productTagInput')
            ...
            .autocomplete({
                ...
                focus: function(event, ui) {
                    ...
                    //$(this).val(ui.item.Team__r.Name + ' > ' + ui.item.Name);
                    return false;
                },
                ...
                select: function(event, ui) {
                    ...
                    //return $('<li><a></a></li>').find('a').text(item.Team__r.Name + ' > ' + item.Name).end().data("item.autocomplete", item).appendTo(ul);
                    return $("<li>").attr('role','option').attr('id','selection-' + item.Id).attr("data-value", item.Team__r.Name + ' > ' + item.Name).append(item.Team__r.Name + ' > ' + item.Name).appendTo(ul);
                }
    },
